...
import Controlador.ControladorExtras;
 ...
 * @author K.G 
 */
public class Opcion3_HorasExtra extends javax.swing.JFrame {

    public ControladorExtras horasExtras;
    public boolean verificar;
    public Usuario usuario;

    public Opcion3_HorasExtra() {
        sentencias(false, "Usuario");
        opRepositorio.setEnabled(verificar);
    }

    public Opcion3_HorasExtra(Usuario usuario) {
        this.usuario = usuario;
        sentencias(true, usuario.getNombre());
    }

    public void sentencias(boolean i, String usu) {
        initComponents();
        this.verificar = i;
        this.setLocationRelativeTo(Opcion3_HorasExtra.this);
        this.setResizable(false);
        SpinnerNumberModel numero = new SpinnerNumberModel();
        numero.setMinimum(1);
        txt_horasTrabajadas.setModel(numero);
        txt_horasTrabajadas.setValue(1);
        txtNombre.setText(usu);
    ...
    private void initComponents() {
        ...
        txt_horasTrabajadas = new javax.swing.JSpinner();
        ...
        jLabel1.setText(" CALCULAR HORAS EXTRAS");
        jLabel1.setToolTipText("");

        jLabel2.setBackground(new java.awt.Color(51, 0, 51));
        jLabel2.setFont(new java.awt.Font("Vladimir Script", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_");
        ...
        jButton_enviar.setBackground(new java.awt.Color(51, 0, 51));
        ...
        txt_horasTrabajadas.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        txt_horasTrabajadas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        txt_horasTrabajadas.setName(""); // NOI18N
        txt_horasTrabajadas.setOpaque(true);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_sueldoBasico, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                            .addComponent(txt_horasTrabajadas)))
                ...
                .addGap(160, 160, 160))
            .addComponent(jLabel6, javax.swing.GroupLayout.DEFAULT_SIZE, 808, Short.MAX_VALUE)
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel_Resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 341, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txt_horasTrabajadas, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(41, 41, 41)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton_enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_enviarActionPerformed
        try {
            horasExtras = new Controlador.ControladorExtras(Integer.parseInt(txt_horasTrabajadas.getValue().toString()), Double.parseDouble(txt_sueldoBasico.getText()));
            jLabel_Resultado.setText(String.valueOf(horasExtras.resultado()));
    ...
    private void opRepositorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opRepositorioActionPerformed
        ...
        if (nombre != null) {
            ...
            if (ruta1.length() != 0) {
                c.AgregarPDFBaseDatos(ruta1, usuario, nombre, "Horas extra");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new Opcion3_HorasExtra().setVisible(true);
        });
    }
    ...
    private javax.swing.JSpinner txt_horasTrabajadas;
