 ...
 * @author K.G 
 */
public class Suplementarias extends Horas implements InterfaceCalculosHoras {

    public final double PORCENTAJE = 0.50;

    public Suplementarias(int horas, double sueldoBasico) {
